package com.example.google_map_activity;
...
import com.example.google_map_activity.databinding.ActivityMapsBinding;
...
//        LatLng mehsana = (new LatLng(23.586761, 72.369949));
//        mMap.addMarker(new MarkerOptions().position(mehsana).title("Marker in Mehsana"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mehsana, 13));
